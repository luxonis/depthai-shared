...
struct CaptureMetadata {
    enum class Command : uint8_t { NO_COMMAND = 0, CAPTURE_STILL, AUTOFOCUS_TRIGGER, AUTOFOCUS_MODE };

    enum class AutofocusMode : uint8_t { AF_MODE_AUTO = 0, AF_MODE_MACRO, AF_MODE_CONTINUOUS_VIDEO, AF_MODE_CONTINUOUS_PICTURE, AF_MODE_EDOF };
